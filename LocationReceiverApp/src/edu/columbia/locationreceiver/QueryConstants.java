...
public class QueryConstants {
	...
	public static final String INSERT_LOCATION = "insert into location(location_id, name, building, floor, room, street, city, zip, device_id, updated) values (?,?,?,?,?,?,?,?,?,?);";
	...
	public static final String INSERT_COORDINATES = "insert into coordinates(device_id, latitude, longitude, updated, altitude, speed, accuracy, provider) values (?,?,?,?,?,?,?,?);";
	public static final String INSERT_WIFI_READING = "insert into wifi_reading(device_id, ssid, frequency, level, updated) values (?,?,?,?,?);";
	public static final String INSERT_DEVICE_INFO = "insert into device_info(os_version,build_version,build_version_sdk,device,model,product,updated) values (?,?,?,?,?,?,?);";
